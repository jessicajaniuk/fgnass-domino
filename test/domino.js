...
exports.qsaOrder = function () {
  ...
  Array.from(window.querySelectorAll('h2, h3'))
    .map(function (el) {
      return el.tagName;
    })
...
exports.treeWalker = function () {
  ...
  var tw = d.createTreeWalker(root, window.NodeFilter.SHOW_TEXT, function (n) {
    return n.data === 'ignore' ? window.NodeFilter.FILTER_REJECT : window.NodeFilter.FILTER_ACCEPT;
  });
...
exports.nodeIterator2 = function () {
  ...
  var document = domino.createDocument('<a>123<b>456<script>alert(1)</script></b></a>789');
...
exports.attributeSelector = function () {
  var html =
    '<h1>foo</h1><h2 id="x" title="y" lang="en" dir="ltr" ' +
...
exports.template1 = function () {
  ...
  document.body.innerHTML.should.equal(
    '<table><tbody><template id="row"><tr><td></td><td></td></tr></template></tbody></table>'
  );
...
exports.fosterParent1 = function () {
  ...
  document.body.innerHTML.should.equal(
    'x<a>foo</a><table><tbody><tr><td>y</td></tr></tbody></table>'
  );
};
...
exports.fosterParent3 = function () {
  var document = domino.createDocument(
    '<body><template><table><tr>x</template><table><template><tr>y'
  );
  document.body.innerHTML.should.equal(
    '<template>x<table><tbody><tr></tr></tbody></table></template><table><template><tr></tr>y</template></table>'
  );
  ...
  templates[0].content.ownerDocument.should.equal(templates[1].content.ownerDocument);
};
...
exports.dialogTag = function () {
  ...
  document.body.innerHTML.should.equal(
    '<div><p>x</p><dialog open="" returnvalue="foo">y</dialog></div>'
  );
...
exports.menuItemTag = function () {
  ...
  document.body.innerHTML.should.equal(
    '<menuitem type="checkbox" checked="" default=""></menuitem>'
  );
...
exports.rubyTags = function () {
  ...
  Array.prototype.forEach.call(document.querySelectorAll('ruby,rb,rp,rt,rtc'), function (el) {
...
exports.sourceTag = function () {
  var document = domino.createDocument(
    '<base href=http://example.com><video controls><source src="foo.webm" type="video/webm">Sorry, no HTML5 video.'
  );
  document.body.innerHTML.should.equal(
    '<video controls=""><source src="foo.webm" type="video/webm">Sorry, no HTML5 video.</video>'
  );
...
exports.trackTag = function () {
  var document = domino.createDocument(
    '<base href=http://example.com><video poster="foo.jpg"><source src="foo.webm" type="video/webm"><track kind="captions" src="en-captions.vtt" srclang="en">'
  );
  document.body.innerHTML.should.equal(
    '<video poster="foo.jpg"><source src="foo.webm" type="video/webm"><track kind="captions" src="en-captions.vtt" srclang="en"></video>'
  );
...
exports.elementInterface = function () {
  ...
  ['listing', 'xmp', 'pre'].forEach(function (tag) {
    var document = domino.createDocument('<' + tag + '>');
    var elt = document.querySelector(tag);
    elt.should.be.instanceof(domino.impl.HTMLElement);
...
exports.menuitem = function () {
  ...
  var document = domino.createDocument(doc);
  document.body.innerHTML.should.equal(
    '<menuitem id="a" label=" b "></menuitem><menuitem id="c"> d <b> e </b></menuitem>'
  );
...
exports.gh95 = function () {
  var document = domino.createDocument('<body><a href="foo\'s">bar</a></body>');
  (function () {
...
exports.gh99 = function () {
  ...
  var window = domino.createWindow('<!DOCTYPE html><html><body></body></html>');
...
exports.gh119 = function () {
  ...
  div.outerHTML.should.equal(
    '<div style="flex-basis: 0px; flex-grow: 1; flex-shrink: 1; flex-direction: column; flex-wrap: wrap;"></div>'
  );
};
...
exports.outerHTML1 = function () {
  var document = domino.createDocument('<div id="d"><p>Content</p><p>Further Elaborated</p></div>');
  var d = document.getElementById('d');
  d.outerHTML.should.equal('<div id="d"><p>Content</p><p>Further Elaborated</p></div>');
};
...
exports.bodyNL = function () {
  var document = domino.createDocument('<body></body>\n');
...
exports.incrementalHTMLParser1 = function () {
  ...
  incrParser
    .document()
    .outerHTML.should.equal('<html><head></head><body><p>hello<b>foo&amp;</b></p></body></html>');
};
